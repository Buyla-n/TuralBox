...
import com.tural.box.parser.IntReader
import com.tural.box.parser.StringBlock
import com.tural.box.parser.TypedValue
import com.tural.box.parser.XmlPullParserException
...
class AXmlResourceParser {
	...
	fun getAttributeValue(index: Int): String? {
		...
		if (valueType== TypedValue.Companion.TYPE_STRING) {
